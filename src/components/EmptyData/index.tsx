    ...
    <div className="container flex flex-col md:flex-row items-center justify-center text-gray-700">
      <div className="max-w-md">
        ...
        <p className="mb-8 mt-2">
          To create memories and find out what your friend share you need to
          sign in.
        </p>
        ...
        <button
          ...
          className={classNames(
            "btn text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700",
